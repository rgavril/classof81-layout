class ConfigMenuEntry {
	...
	constructor(parent_surface, x, y) {
		...
		# Title
		this.title_label = this.surface.add_text(title, this.background_image.x + 20, this.background_image.y - 1, this.background_image.texture_width - 40, this.background_image.texture_height);
		...
		# Value
		this.value_label = this.surface.add_text(value, this.background_image.x + 20, this.background_image.y - 1, this.background_image.texture_width - 40, this.background_image.texture_height);
